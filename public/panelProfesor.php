...
// Registro de dictámenes emitidos por el profesor como integrante de la CATT
    ...
    <main class="dashboard-main">
        ...
        <section class="dashboard-panel">
            <div class="panel-header">
                <h2>Próximas Fechas de la CATT</h2>
            ...
            <div class="activity-summary">
                <div class="summary-item">
                    ...
                    <div>
                        <strong>Revisión de protocolos</strong>
                ...
                <div class="summary-item">
                    ...
                    <div>
                        <strong>Sesión de evaluación de la comisión</strong>
                ...
                <div class="summary-item">
                    ...
                    <div>
                        <strong>Publicación de dictámenes</strong>
    ...
    <?php elseif ($modal === 'revisiones'): ?>
        <section class="dashboard-modal-content" aria-labelledby="modal-revisiones-title">
            ...
            <div class="empty-modal">
                ...
                <a class="button button-primary" href="panelProfesor.php?modal=formatos">Registrar un dictamen</a>
            </div>
        </section>
