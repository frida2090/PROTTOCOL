...
<section id="procesos" class="home-section process-section">
    <div id="acompañamiento-heading" class="section-heading">
        <p id="acompañamiento" class="eyebrow">Acompañamiento</p>
